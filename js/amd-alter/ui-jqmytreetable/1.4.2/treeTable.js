...
(function($) {
	/*
	 * window.SITE_URL = window.SITE_URL || ''; if
	 * (document.location.href.indexOf('http://') != 0) { var path =
	 * '../script/treeTable/'; } else { var path = SITE_URL +
	 * '/script/treeTable/'; }
	 */
			...
			$("head")
					.append(
							'<link id="tree_table_'
									...
									+ path
									+ opts.theme
									+ '/treeTable.css" rel="stylesheet" type="text/css" />');
		}
		var css = {
			N : opts.theme + "_node",
...
if ( typeof define === "function" && define.amd ) {
    define( 'jqtreetable', ['jquery'], function (jQuery) { return jQuery; } );
}